    ...
    // check diagnolas
      ...
      ($(this).hasClass('disable')){
        ...
        (turns % 2 == 0)
          ...
          (#one_one.hasClass('O') && #one_two.hasClass('O') && #one_three.hasClass('O')) || // {return true}
          (#two_one.hasClass('O') && #two_two.hasClass('O') && #two_three.hasClass('O')) || // {return true}
          (#three_one.hasClass('O') && #three_two.hasClass('O') && #three_three.hasClass('O')) // {return true}
          (#one_one.hasClass('O') && #two_one.hasClass('O') && #three_one.hasClass('O')) ||// {return true}
          (#one_two.hasClass('O') === #two_two.hasClass('O') === #three_two.hasClass('O')) || // {return true}
          (#one_three.hasClass('O') === #two_three.hasClass('O') === #three_three.hasClass('O')) || // {return true}
          (#one_one.hasClass('O') === #two_#two.hasClass('O') === #three_three.hasClass('O')) || // {return true}
          (#one_three.hasClass('O') === #two_#two.hasClass('O')) === #three_one.hasClass('O')) {
            alert('Winner is Player 1')
            turns = 0
          }
        else {
