  ...
  return $.ajax({
    ...
    data: {
      'credentials': {
        ...
        'password-confirmation': data.credentials.password
      }
    }
  });
};
...
$(document).ready(function () {
  var X = 'X'; // X=Player2//if get this working add image
  var O = 'O'; // O=Player1
  var turns = 0;
  var one_one = $('#one_one');
  var one_two = $('#one_two');
  var one_three = $('#one_three');
  var two_one = $('#two_one');
  var two_two = $('#two_two');
  var two_three = $('#two_three');
  var three_one = $('#three_one');
  var three_two = $('#three_two');
  var three_three = $('#three_three');
  ...
  $('#boardContainer tr td').on('click', function () {
    if (one_one.hasClass('O') && one_two.hasClass('O') && one_three.hasClass('O') || two_one.hasClass('O') && two_two.hasClass('O') && two_three.hasClass('O') || three_one.hasClass('O') && three_two.hasClass('O') && three_three.hasClass('O') || one_one.hasClass('O') && two_one.hasClass('O') && three_one.hasClass('O') || one_two.hasClass('O') && two_two.hasClass('O') && three_two.hasClass('O') || one_three.hasClass('O') && two_three.hasClass('O') && three_three.hasClass('O') || one_one.hasClass('O') && two_two.hasClass('O') && three_three.hasClass('O') || one_three.hasClass('O') && two_two.hasClass('O') && three_one.hasClass('O')) {
    ...
    } else if (one_one.hasClass('X') && one_two.hasClass('X') && one_three.hasClass('X') || two_one.hasClass('X') && two_two.hasClass('X') && two_three.hasClass('X') || three_one.hasClass('X') && three_two.hasClass('X') && three_three.hasClass('X') || one_one.hasClass('X') && two_one.hasClass('X') && three_one.hasClass('X') || one_two.hasClass('X') && two_two.hasClass('X') && three_two.hasClass('X') || one_three.hasClass('X') && two_three.hasClass('X') && three_three.hasClass('X') || one_one.hasClass('X') && two_two.hasClass('X') && three_three.hasClass('X') || one_three.hasClass('X') && two_two.hasClass('X') && three_one.hasClass('X')) {
      ...
      if (one_one.hasClass('X') && one_two.hasClass('X') && one_three.hasClass('X') || two_one.hasClass('X') && two_two.hasClass('X') && two_three.hasClass('X') || three_one.hasClass('X') && three_two.hasClass('X') && three_three.hasClass('X') || one_one.hasClass('X') && two_one.hasClass('X') && three_one.hasClass('X') || one_two.hasClass('X') && two_two.hasClass('X') && three_two.hasClass('X') || one_three.hasClass('X') && two_three.hasClass('X') && three_three.hasClass('X') || one_one.hasClass('X') && two_two.hasClass('X') && three_three.hasClass('X') || one_three.hasClass('X') && two_two.hasClass('X') && three_one.hasClass('X')) {
        alert('Winner is Player 2');
        scoreTwo = scoreTwo + 1;
        $('#span2').html(scoreTwo);
      }
